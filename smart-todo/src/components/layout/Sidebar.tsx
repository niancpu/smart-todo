...
export default function Sidebar() {
  return (
    <aside className="hidden md:flex flex-col w-64 h-screen glass-heavy fixed left-0 top-0 z-30 rounded-r-2xl">
      {/* Logo */}
      <div className="p-5 flex items-center gap-3">
        ...
        <h1 className="font-display text-lg font-semibold text-slate-800 tracking-tight">Smart Todo</h1>
      </div>

      {/* Navigation */}
      <nav className="flex-1 px-3 py-2 space-y-1 stagger-children">
        {navItems.map((item) => (
          <NavLink
            key={item.to}
            to={item.to}
